package me.relend.parkour.commands;
...
public abstract class Command extends BukkitCommand {
	...
	public final List<String> tabComplete(CommandSender sender, String alias, String[] args) throws IllegalArgumentException {
		if (sender instanceof Player) {
			...
			return tabComplete((ConsoleCommandSender) sender, args);
		}
	}

	public List<String> tabComplete(ConsoleCommandSender console, String[] args) {
		return null;
	}
